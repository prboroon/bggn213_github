...
- [QUESTION 1: How many observations are in this dataset? -
  569](#question-1-how-many-observations-are-in-this-dataset---569)
- [QUESTION 2: How many of the observations have a malignant
  diagnosis? -
  212](#question-2-how-many-of-the-observations-have-a-malignant-diagnosis---212)
- [QUESTION 3: How many variables/features in the data are suffixed with
  \_mean? -
  10](#question-3-how-many-variablesfeatures-in-the-data-are-suffixed-with-_mean---10)
- [Check column means and standard
  ...
  - [QUESTION 4:From your results, what proportion of the original
    variance is captured by the first principal components
    (PC1)?](#question-4from-your-results-what-proportion-of-the-original-variance-is-captured-by-the-first-principal-components-pc1)
  - [QUESTION 5: How many principal components (PCs) are required to
    describe at least 70% of the original variance in the
    data?](#question-5-how-many-principal-components-pcs-are-required-to-describe-at-least-70-of-the-original-variance-in-the-data)
  - [QUESTION 6: How many principal components (PCs) are required to
    describe at least 90% of the original variance in the
    data?](#question-6-how-many-principal-components-pcs-are-required-to-describe-at-least-90-of-the-original-variance-in-the-data)
  - [QUESTION 7: What stands out to you about this plot? Is it easy or
    difficult to understand?
    Why?](#question-7-what-stands-out-to-you-about-this-plot-is-it-easy-or-difficult-to-understand-why)
  - [QUESTION 8: Generate a similar plot for principal components 1
    and 3. What do you notice about these
    plots?](#question-8-generate-a-similar-plot-for-principal-components-1-and-3-what-do-you-notice-about-these-plots)
  - [QUESTION 9: For the first principal component, what is the
    component of the loading vector (i.e. wisc.pr\$rotation\[,1\]) for
    the feature concave.points_mean? This tells us how much this
    original feature contributes to the first
    PC.](#question-9-for-the-first-principal-component-what-is-the-component-of-the-loading-vector-ie-wiscprrotation1-for-the-feature-concavepoints_mean-this-tells-us-how-much-this-original-feature-contributes-to-the-first-pc)
  - [QUESTION 10: Using the plot() and abline() functions, what is the
    height at which the clustering model has 4
    clusters?](#question-10-using-the-plot-and-abline-functions-what-is-the-height-at-which-the-clustering-model-has-4-clusters)
  - [QUESTION 12: Which method gives your favorite results for the same
    data.dist dataset? Explain your
    reasoning.](#question-12-which-method-gives-your-favorite-results-for-the-same-datadist-dataset-explain-your-reasoning)
  - [QUESTION 13 How well does the newly created model with four
    clusters separate out the two
    diagnoses?](#question-13-how-well-does-the-newly-created-model-with-four-clusters-separate-out-the-two-diagnoses)
  - [QUESTION 14 How well do the hierarchical clustering models you
    created in previous sections (i.e. before PCA) do in terms of
    separating the diagnoses? Again, use the table() function to compare
    the output of each model (wisc.km\$cluster and wisc.hclust.clusters)
    with the vector containing the actual
    diagnoses.](#question-14-how-well-do-the-hierarchical-clustering-models-you-created-in-previous-sections-ie-before-pca-do-in-terms-of-separating-the-diagnoses-again-use-the-table-function-to-compare-the-output-of-each-model-wisckmcluster-and-wischclustclusters-with-the-vector-containing-the-actual-diagnoses)
  - [QUESTION 16 Which of these new patients should we prioritize for
    follow up based on your
    results?](#question-16-which-of-these-new-patients-should-we-prioritize-for-follow-up-based-on-your-results)

## Background

The goal of this mini-project is for you to explore a complete analysis
using the unsupervised learning techniques covered in the last class.
You’ll extend what we learned by combining PCA as a pre-processing step
...
This plot (biplot) is incredibly difficult to understand as it just
shows a huge blob/cluster that is difficult to interpret. The whole
point of the PCA plot is to visualize the trend of observations and
variables and the graph before me is very difficult to interpret.
...
PC1 vs. PC2 plot shows a wider overview of separation and a view of the
two benign and malignant clusters while PC1 vs. PC3 plot shows subtle
changes in the spread of clusters.
...
-0.2608538 means that when concave.points_mean increases, the value of
PC1 tends to decrease. Higher concave.points_mean values is associated
with malignant samples because malignant samples have more irregular
concave borders.
...
```
                        ...
                        diagnosis
    wisc.hclust.clusters Benign Malignant
                       1     12       165
                       2      2         5
                       3    343        40
                       4      0         2
...
The method that gave me my favorite results was the ward.D2 method
because it merges clusters to minimize the increase in total
within-cluster variance. I like being able to visualize more compact,
...
Separates them very well, there isn’t a huge overlap between the two
clusters.
...
```
                           ...
                           diagnosis
    wisc.pr.hclust.clusters Benign Malignant
                          1     28       188
                          2    329        24
...
We should prioritize the malignant group because it is more varied in
their tumor cells.
...
```
    ...
    [1] factoextra_1.0.7 ggplot2_4.0.1   
    ...
    [25] broom_1.0.10       xfun_0.54          S7_0.2.1           cli_3.6.5         
    ...
    [41] carData_3.0-5      rmarkdown_2.30     purrr_1.2.0        tools_4.5.1       
